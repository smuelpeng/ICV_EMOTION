...
class LiftedStructSimilaritySoftmaxLossParameter;
class LogParameter;
class LossParameter;
class MVNParameter;
...
class LayerParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LayerParameter) */ {
 public:
  ...
  // optional .caffe.LiftedStructSimilaritySoftmaxLossParameter lifted_struct_sim_softmax_loss_param = 148;
  bool has_lifted_struct_sim_softmax_loss_param() const;
  void clear_lifted_struct_sim_softmax_loss_param();
  static const int kLiftedStructSimSoftmaxLossParamFieldNumber = 148;
  const ::caffe::LiftedStructSimilaritySoftmaxLossParameter& lifted_struct_sim_softmax_loss_param() const;
  ::caffe::LiftedStructSimilaritySoftmaxLossParameter* mutable_lifted_struct_sim_softmax_loss_param();
  ::caffe::LiftedStructSimilaritySoftmaxLossParameter* release_lifted_struct_sim_softmax_loss_param();
  void set_allocated_lifted_struct_sim_softmax_loss_param(::caffe::LiftedStructSimilaritySoftmaxLossParameter* lifted_struct_sim_softmax_loss_param);
 ...
 private:
  ...
  inline void set_has_lifted_struct_sim_softmax_loss_param();
  inline void clear_has_lifted_struct_sim_softmax_loss_param();
  ...
  ::caffe::LiftedStructSimilaritySoftmaxLossParameter* lifted_struct_sim_softmax_loss_param_;
...
class LiftedStructSimilaritySoftmaxLossParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LiftedStructSimilaritySoftmaxLossParameter) */ {
 public:
  LiftedStructSimilaritySoftmaxLossParameter();
  virtual ~LiftedStructSimilaritySoftmaxLossParameter();

  LiftedStructSimilaritySoftmaxLossParameter(const LiftedStructSimilaritySoftmaxLossParameter& from);

  inline LiftedStructSimilaritySoftmaxLossParameter& operator=(const LiftedStructSimilaritySoftmaxLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const LiftedStructSimilaritySoftmaxLossParameter& default_instance();

  static const LiftedStructSimilaritySoftmaxLossParameter* internal_default_instance();

  void Swap(LiftedStructSimilaritySoftmaxLossParameter* other);

  // implements Message ----------------------------------------------

  inline LiftedStructSimilaritySoftmaxLossParameter* New() const { return New(NULL); }

  LiftedStructSimilaritySoftmaxLossParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const LiftedStructSimilaritySoftmaxLossParameter& from);
  void MergeFrom(const LiftedStructSimilaritySoftmaxLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(LiftedStructSimilaritySoftmaxLossParameter* other);
  void UnsafeMergeFrom(const LiftedStructSimilaritySoftmaxLossParameter& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  // @@protoc_insertion_point(class_scope:caffe.LiftedStructSimilaritySoftmaxLossParameter)
 private:
  inline void set_has_margin();
  inline void clear_has_margin();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<LiftedStructSimilaritySoftmaxLossParameter> LiftedStructSimilaritySoftmaxLossParameter_default_instance_;
...
class CenterLossParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.CenterLossParameter) */ {
 public:
  ...
  static const CenterLossParameter* internal_default_instance();

  void Swap(CenterLossParameter* other);

  // implements Message ----------------------------------------------

  inline CenterLossParameter* New() const { return New(NULL); }

  CenterLossParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const CenterLossParameter& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<CenterLossParameter> CenterLossParameter_default_instance_;
...
// optional .caffe.LiftedStructSimilaritySoftmaxLossParameter lifted_struct_sim_softmax_loss_param = 148;
inline bool LayerParameter::has_lifted_struct_sim_softmax_loss_param() const {
  return (_has_bits_[1] & 0x00000400u) != 0;
}
inline void LayerParameter::set_has_lifted_struct_sim_softmax_loss_param() {
  _has_bits_[1] |= 0x00000400u;
}
inline void LayerParameter::clear_has_lifted_struct_sim_softmax_loss_param() {
  _has_bits_[1] &= ~0x00000400u;
}
inline void LayerParameter::clear_lifted_struct_sim_softmax_loss_param() {
  if (lifted_struct_sim_softmax_loss_param_ != NULL) lifted_struct_sim_softmax_loss_param_->::caffe::LiftedStructSimilaritySoftmaxLossParameter::Clear();
  clear_has_lifted_struct_sim_softmax_loss_param();
}
inline const ::caffe::LiftedStructSimilaritySoftmaxLossParameter& LayerParameter::lifted_struct_sim_softmax_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.lifted_struct_sim_softmax_loss_param)
  return lifted_struct_sim_softmax_loss_param_ != NULL ? *lifted_struct_sim_softmax_loss_param_
                         : *::caffe::LiftedStructSimilaritySoftmaxLossParameter::internal_default_instance();
}
inline ::caffe::LiftedStructSimilaritySoftmaxLossParameter* LayerParameter::mutable_lifted_struct_sim_softmax_loss_param() {
  set_has_lifted_struct_sim_softmax_loss_param();
  if (lifted_struct_sim_softmax_loss_param_ == NULL) {
    lifted_struct_sim_softmax_loss_param_ = new ::caffe::LiftedStructSimilaritySoftmaxLossParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.lifted_struct_sim_softmax_loss_param)
  return lifted_struct_sim_softmax_loss_param_;
}
inline ::caffe::LiftedStructSimilaritySoftmaxLossParameter* LayerParameter::release_lifted_struct_sim_softmax_loss_param() {
  // @@protoc_insertion_point(field_release:caffe.LayerParameter.lifted_struct_sim_softmax_loss_param)
  clear_has_lifted_struct_sim_softmax_loss_param();
  ::caffe::LiftedStructSimilaritySoftmaxLossParameter* temp = lifted_struct_sim_softmax_loss_param_;
  lifted_struct_sim_softmax_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_lifted_struct_sim_softmax_loss_param(::caffe::LiftedStructSimilaritySoftmaxLossParameter* lifted_struct_sim_softmax_loss_param) {
  delete lifted_struct_sim_softmax_loss_param_;
  lifted_struct_sim_softmax_loss_param_ = lifted_struct_sim_softmax_loss_param;
  if (lifted_struct_sim_softmax_loss_param) {
    set_has_lifted_struct_sim_softmax_loss_param();
  } else {
    clear_has_lifted_struct_sim_softmax_loss_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.lifted_struct_sim_softmax_loss_param)
}
...
// optional float margin = 1 [default = 1];
inline bool LiftedStructSimilaritySoftmaxLossParameter::has_margin() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void LiftedStructSimilaritySoftmaxLossParameter::set_has_margin() {
  _has_bits_[0] |= 0x00000001u;
}
inline void LiftedStructSimilaritySoftmaxLossParameter::clear_has_margin() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void LiftedStructSimilaritySoftmaxLossParameter::clear_margin() {
  margin_ = 1;
  clear_has_margin();
}
inline float LiftedStructSimilaritySoftmaxLossParameter::margin() const {
  // @@protoc_insertion_point(field_get:caffe.LiftedStructSimilaritySoftmaxLossParameter.margin)
  return margin_;
}
inline void LiftedStructSimilaritySoftmaxLossParameter::set_margin(float value) {
  set_has_margin();
  margin_ = value;
  // @@protoc_insertion_point(field_set:caffe.LiftedStructSimilaritySoftmaxLossParameter.margin)
}

inline const LiftedStructSimilaritySoftmaxLossParameter* LiftedStructSimilaritySoftmaxLossParameter::internal_default_instance() {
  return &LiftedStructSimilaritySoftmaxLossParameter_default_instance_.get();
}
// -------------------------------------------------------------------
...
inline const CenterLossParameter* CenterLossParameter::internal_default_instance() {
  return &CenterLossParameter_default_instance_.get();
}
